...
// import Sort from "./presenter/sort";
...
// const sortPresenter = new Sort(tripEventElement); // создал призентер с элементом в который вставить sort компанент
// sortPresenter.init(getTripEventsSort().sortItems); // вызвал функцию init в которую передал мок данные
// // renderSort();
// renderEventList();
//
// if (tripItems.length) {
