...
export default class AbstractView {
  constructor() {
    ...
    // НЕ ПОНИМАЮ ведь снятия внутри компонента не происходит оно находится в main.js
  ...
  getElement() {
    ...
    if (!this._element) { // если значение содержимого приватного поля не заполнено
      ...
      // НЕ понимаю зачем создовать createElement. Потому что не вставишь элемент через raplaceChild внутрь Дом, в
      // getTemplate находится функция которая возвращет строку и в ставится она как строка в "" а надо как элемент
      // и из-за этого создаем элемент как бы конвертируем)
    }
