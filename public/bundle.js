...
/* harmony import */ var _css_loader_dist_cjs_js_flatpickr_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !../../css-loader/dist/cjs.js!./flatpickr.css */ "./node_modules/css-loader/dist/cjs.js!./node_modules/flatpickr/dist/flatpickr.css");
...
var update = _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_css_loader_dist_cjs_js_flatpickr_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);



/* harmony default export */ __webpack_exports__["default"] = (_css_loader_dist_cjs_js_flatpickr_css__WEBPACK_IMPORTED_MODULE_1__["default"].locals || {});
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _view_trip_filter_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./view/trip-filter.js */ "./src/view/trip-filter.js");
/* harmony import */ var _util_render__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./util/render */ "./src/util/render.js");
/* harmony import */ var _view_trip_menu_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./view/trip-menu.js */ "./src/view/trip-menu.js");
/* harmony import */ var _mock_mock_trip_event_item_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./mock/mock-trip-event-item.js */ "./src/mock/mock-trip-event-item.js");
/* harmony import */ var _presenter_tripBoard__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./presenter/tripBoard */ "./src/presenter/tripBoard.js");
/* harmony import */ var _presenter_tripInfo__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./presenter/tripInfo */ "./src/presenter/tripInfo.js");
...
const tripItems = new Array(DATA_COUNT).fill().map(_mock_mock_trip_event_item_js__WEBPACK_IMPORTED_MODULE_3__["getTripEventItem"]);
...
const renderMenu = () => {
  ...
  Object(_util_render__WEBPACK_IMPORTED_MODULE_1__["renderElement"])(visuallyHiddenFirstH2Element, new _view_trip_menu_js__WEBPACK_IMPORTED_MODULE_2__["default"](), _util_render__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].AFTEREND); // рендер меню
};

const renderFilter = () => {
  Object(_util_render__WEBPACK_IMPORTED_MODULE_1__["renderElement"])(tripControlsElement, new _view_trip_filter_js__WEBPACK_IMPORTED_MODULE_0__["default"](), _util_render__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].BEFOREEND); // рендер фильтр хедер
};
...
renderMenu();
renderFilter();
const tripBoardPresenter = new _presenter_tripBoard__WEBPACK_IMPORTED_MODULE_4__["default"](tripEventElement); // создал призентер с контейнером в который вставим все
const tripInfoPresenter = new _presenter_tripInfo__WEBPACK_IMPORTED_MODULE_5__["default"](tripMainElement); // tripInfoElement
...
/***/ "./src/mock/mock-trip-event-item.js":
/*!******************************************!*\
  !*** ./src/mock/mock-trip-event-item.js ***!
  \******************************************/
/*! exports provided: TYPES, dataOffers, getDestination, destinations, getTripEventItem */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TYPES", function() { return TYPES; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "dataOffers", function() { return dataOffers; });
...
/* harmony import */ var _util_common_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../util/common.js */ "./src/util/common.js");
...
const generateDate = () => {
  ...
  const maxHoursGap = 4;
  const hoursGap = Object(_util_common_js__WEBPACK_IMPORTED_MODULE_1__["getRandomInteger"])(1, maxHoursGap);
  const dateFinish = dayjs__WEBPACK_IMPORTED_MODULE_0___default()().add(hoursGap, `day`).add(hoursGap, `hour`).add(-hoursGap, `minute`).toDate(); // рандом
  // день
  return dateFinish;
};
...
const generateDateStart = () => {
  ...
  const maxDaysGap = 3;
  const daysGap = Object(_util_common_js__WEBPACK_IMPORTED_MODULE_1__["getRandomInteger"])(-maxDaysGap, 1);
  const dateStart = dayjs__WEBPACK_IMPORTED_MODULE_0___default()().add(daysGap, `day`).add(daysGap, `hour`).add(-maxDaysGap, `minute`).toDate();
...
const getDescription = (items) => {
  ...
  for (let i = 0; i < Object(_util_common_js__WEBPACK_IMPORTED_MODULE_1__["getRandomInteger"])(0, 5); i++) {
...
const getPhotos = () => {
  const photos = [];
  const PHOTO_COUNT = 5;
  for (let i = 0; i < Object(_util_common_js__WEBPACK_IMPORTED_MODULE_1__["getRandomInteger"])(1, PHOTO_COUNT); i++) {
...
const getDestination = () => {
  return {
    ...
    "name": destinationItems[Object(_util_common_js__WEBPACK_IMPORTED_MODULE_1__["getRandomInteger"])(0, destinationItems.length - 1)],
    "pictures": [
      {
        "src": getPhotos(),
...
const getTripEventItem = () => {
  ...
  const randomType = TYPES[Object(_util_common_js__WEBPACK_IMPORTED_MODULE_1__["getRandomInteger"])(1, TYPES.length - 1)];
  return {
    "type": randomType, // TYPES[getRandomInteger(1, TYPES.length - 1)], // getTypeOffer(randomCheckOffer)
    "basePrice": prices[Object(_util_common_js__WEBPACK_IMPORTED_MODULE_1__["getRandomInteger"])(0, prices.length - 1)],
    "dateFrom": generateDateStart(),
    "dateTo": generateDate(),
    "destination": getDestination(),
    "id": generateId(),
    "isFavorite": Object(_util_common_js__WEBPACK_IMPORTED_MODULE_1__["getRandomInteger"])(0, 1),
...
/* harmony import */ var _view_trip_event_edit_form__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../view/trip-event-edit-form */ "./src/view/trip-event-edit-form.js");
/* harmony import */ var _view_trip_event_item__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../view/trip-event-item */ "./src/view/trip-event-item.js");
...
class Event {
  ...
  init(tripItem) {
    ...
    this._tripEventItemComponent = new _view_trip_event_item__WEBPACK_IMPORTED_MODULE_2__["default"](this._tripItem); // виюха для item
    this._tripEventEditComponent = new _view_trip_event_edit_form__WEBPACK_IMPORTED_MODULE_1__["default"](this._tripItem); // вьюха для формы редоктирования
    ...
    if (prevTripEventItemComponent === null || prevTripEventEditComponent === null) { // то компоненты не создавались
      Object(_util_render__WEBPACK_IMPORTED_MODULE_0__["renderElement"])(this._eventContainer, this._tripEventItemComponent, _util_render__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND);
    ...
    Object(_util_render__WEBPACK_IMPORTED_MODULE_0__["remove"])(prevTripEventItemComponent);
    Object(_util_render__WEBPACK_IMPORTED_MODULE_0__["remove"])(prevTripEventEditComponent);
  }

  // метод по удалению event
  destroy() {
    Object(_util_render__WEBPACK_IMPORTED_MODULE_0__["remove"])(this._tripEventItemComponent);
    Object(_util_render__WEBPACK_IMPORTED_MODULE_0__["remove"])(this._tripEventEditComponent);
  }
...
/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! dayjs */ "./node_modules/dayjs/dayjs.min.js");
/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(dayjs__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _view_trip_event_msg_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../view/trip-event-msg.js */ "./src/view/trip-event-msg.js");
/* harmony import */ var _view_trip_events_list_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../view/trip-events-list.js */ "./src/view/trip-events-list.js");
/* harmony import */ var _util_render__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../util/render */ "./src/util/render.js");
/* harmony import */ var _util_common_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../util/common.js */ "./src/util/common.js");
/* harmony import */ var _event_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./event.js */ "./src/presenter/event.js");
/* harmony import */ var _view_trip_events_sort_view__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../view/trip-events-sort-view */ "./src/view/trip-events-sort-view.js");
...
class TripBoard {
  constructor(tripBoardContainer) {
    ...
    this._eventListEmptyMessageComponent = new _view_trip_event_msg_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
    this._tripEventsListComponent = new _view_trip_events_list_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
    this._tripEventsSortComponent = new _view_trip_events_sort_view__WEBPACK_IMPORTED_MODULE_6__["default"]();
    ...
    this._currentSortType = _const__WEBPACK_IMPORTED_MODULE_7__["SortType"].DAY; // сортировка по умолчанию
  ...
  _handleEventChange(updatedEvent) {
    this._tripItems = Object(_util_common_js__WEBPACK_IMPORTED_MODULE_4__["updateItem"])(this._tripItems, updatedEvent); // 1)часть изменили моки
  ...
  _renderEmptyMessage() {
    ...
    Object(_util_render__WEBPACK_IMPORTED_MODULE_3__["renderElement"])(main, this._eventListEmptyMessageComponent, _util_render__WEBPACK_IMPORTED_MODULE_3__["RenderPosition"].BEFOREEND); // вместо удаленнного
    // контейнера проприсовали сообщение
  }

  _sortTripItems(sortType) {
    switch (sortType) {
      case _const__WEBPACK_IMPORTED_MODULE_7__["SortType"].DAY:
        this._tripItems.sort((a, b) => dayjs__WEBPACK_IMPORTED_MODULE_0___default()(a.dateFrom).diff(dayjs__WEBPACK_IMPORTED_MODULE_0___default()(b.dateFrom)));
        break;
  ...
  _renderSort() {
    Object(_util_render__WEBPACK_IMPORTED_MODULE_3__["renderElement"])(this._tripBoardContainer, this._tripEventsSortComponent, _util_render__WEBPACK_IMPORTED_MODULE_3__["RenderPosition"].BEFOREEND);
  ...
  _renderList() {
    Object(_util_render__WEBPACK_IMPORTED_MODULE_3__["renderElement"])(this._tripBoardContainer, this._tripEventsListComponent, _util_render__WEBPACK_IMPORTED_MODULE_3__["RenderPosition"].BEFOREEND);
  }

  _renderItem(tripItem) {
    const eventPresenter = new _event_js__WEBPACK_IMPORTED_MODULE_5__["default"](this._tripEventsListComponent.getElement(), this._handleEventChange, this._handleModeChange);
    // 3 наблюдатель
...
/* harmony import */ var _view_trip_info_cost__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../view/trip-info-cost */ "./src/view/trip-info-cost.js");
...
class TripInfo {
  constructor(tripInfoContainer) {
    ...
    this._destinations = [];
    this._startDateInfo = [];
    this._tripInfoComponent = new _view_trip_info_js__WEBPACK_IMPORTED_MODULE_1__["default"](this._destinations, this._startDateInfo);
  }
  ...
  _renderTotalCost(tripItems) {
    ...
    Object(_util_render__WEBPACK_IMPORTED_MODULE_2__["renderElement"])(tripInfoElement, new _view_trip_info_cost__WEBPACK_IMPORTED_MODULE_0__["default"](this._totalPriceItem), _util_render__WEBPACK_IMPORTED_MODULE_2__["RenderPosition"].BEFOREEND);
  }

  // функция которая выводит дистанцию дат и точек маршрута
  _renderDestination(tripItems) {
    tripItems.sort((a, b) => dayjs__WEBPACK_IMPORTED_MODULE_3___default()(a.dateFrom).diff(dayjs__WEBPACK_IMPORTED_MODULE_3___default()(b.dateFrom))); // сортируем массив дат по порядку
    ...
    Object(_util_render__WEBPACK_IMPORTED_MODULE_2__["renderElement"])(this._tripInfoContainer, this._tripInfoComponent, _util_render__WEBPACK_IMPORTED_MODULE_2__["RenderPosition"].AFTERBEGIN); // рендер промежкутка даты
  }
}
...
const updateItem = (items, update) => { // принимет массив и принимает тот элемент который надо обновить
...
/*!****************************!*\
  !*** ./src/util/render.js ***!
  \****************************/
/*! exports provided: getDateDiff, renderElement, createElement, RenderPosition, remove */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
dayjs__WEBPACK_IMPORTED_MODULE_0___default.a.extend(duration); // это нужно чтобы работало вычетание дат
...
const getDateDiff = (start, finish) => {
  ...
  const timeDuration = dayjs__WEBPACK_IMPORTED_MODULE_0___default.a.duration(diffTimeInMs); // от конечной даты вычли начальную пример {years: 0, months: 0, days: 4, hours: 4, minutes: 1, …}
...
const renderElement = (container, element, position) => {
  if (container instanceof _view_abstract__WEBPACK_IMPORTED_MODULE_1__["default"]) { // если к нам приходит потомок класса Abstract
  ...
  if (element instanceof _view_abstract__WEBPACK_IMPORTED_MODULE_1__["default"]) {
...
/***/ "./src/view/trip-event-edit-form.js":
/*!******************************************!*\
  !*** ./src/view/trip-event-edit-form.js ***!
  \******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return TripEventEditFormView; });
/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! dayjs */ "./node_modules/dayjs/dayjs.min.js");
/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(dayjs__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _smart_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./smart.js */ "./src/view/smart.js");
/* harmony import */ var _mock_mock_trip_event_item_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../mock/mock-trip-event-item.js */ "./src/mock/mock-trip-event-item.js");
...
const createFieldTime = (dateStart, dateFinish) => {
  ...
  const startTime = dayjs__WEBPACK_IMPORTED_MODULE_0___default()(dateStart).format(`DD/MM/YY HH:mm`);
  const finishTime = dayjs__WEBPACK_IMPORTED_MODULE_0___default()(dateFinish).format(`DD/MM/YY HH:mm`);
...
${isActive ? `checked` : ``}>
  ...
  return `<li class="trip-events__item">
       ...
       ${getEditType(_mock_mock_trip_event_item_js__WEBPACK_IMPORTED_MODULE_2__["TYPES"])}
                      </fieldset>
                    </div>
                  </div>
...
class TripEventEditFormView extends _smart_js__WEBPACK_IMPORTED_MODULE_1__["default"] { // AbstractView
  constructor(dataItem) {
    super();
    this._destinations = _mock_mock_trip_event_item_js__WEBPACK_IMPORTED_MODULE_2__["destinations"];
...
// 3.1.
  ...
  _changeDestinationHandler(evt) {
    ...
    const getChangeDestination = (target) => { // target цель выбора пользователя
      for (let item of _mock_mock_trip_event_item_js__WEBPACK_IMPORTED_MODULE_2__["destinations"]) { // прохождение по массиву всех объектов. destinations передали импортом
  ...
  _eventChangeTypeHandler(evt) {
    ...
    const getChangeOffers = (target) => { // target цель выбора пользователя
      for (let item of _mock_mock_trip_event_item_js__WEBPACK_IMPORTED_MODULE_2__["dataOffers"]) { // прохождение по массиву всех объектов. offers массив всех доп предложений
...
const createTripEventItem = (dataItems) => {
  ...
  const startDate = dayjs__WEBPACK_IMPORTED_MODULE_0___default()(dateFrom).format(`HH:mm`); // часы в item
  const finishDate = dayjs__WEBPACK_IMPORTED_MODULE_0___default()(dateTo).format(`HH:mm`);

  const dateStartDay = dayjs__WEBPACK_IMPORTED_MODULE_0___default()(dateFrom).format(`MMM DD`); // дата в item
  ...
  return `<li class="trip-events__item" id="${id}">
              <div class="event">
                ...
                <div class="event__schedule">
                  ...
                  <p class="event__duration">${Object(_util_render_js__WEBPACK_IMPORTED_MODULE_1__["getDateDiff"])(dayjs__WEBPACK_IMPORTED_MODULE_0___default()(dateFrom), dayjs__WEBPACK_IMPORTED_MODULE_0___default()(dateTo))}</p>
                </div>
...
class TripEventItemView extends _abstract_js__WEBPACK_IMPORTED_MODULE_2__["default"] {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return EventListEmptyMessageView; });
...
class EventListEmptyMessageView extends _abstract__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
class TripEventsList extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
/***/ "./src/view/trip-events-sort-view.js":
/*!*******************************************!*\
  !*** ./src/view/trip-events-sort-view.js ***!
  \*******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return TripEventsSortView; });
/* harmony import */ var _abstract__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract */ "./src/view/abstract.js");
...
class TripEventsSortView extends _abstract__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return TripFilterView; });
/* harmony import */ var _abstract_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract.js */ "./src/view/abstract.js");
...
class TripFilterView extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
class TripInfoCostView extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
const createTripInfo = (destinations, starts) => {
  ...
  const dateStartDay = dayjs__WEBPACK_IMPORTED_MODULE_0___default()(starts[0]).format(`MMM DD`);
  const dateFinishDay = dayjs__WEBPACK_IMPORTED_MODULE_0___default()(starts[starts.length - 1]).format(`DD`);
...
class TripInfoView extends _abstract_js__WEBPACK_IMPORTED_MODULE_1__["default"] {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return TripMenuView; });
/* harmony import */ var _abstract_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract.js */ "./src/view/abstract.js");
...
class TripMenuView extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
